...
<body>
    ...
    @include('templates.section-slide')
	@yield('conteudo-view')
	@include('templates.section-newsletter')
	@include('templates.footer-principal')
	@include('templates.footer-secundaria')
	@include('templates.modal-menu')
	@include('templates.modal-busca')
	@stack('scripts')
